...
Original file is located at
    https://colab.research.google.com/drive/12lSmXubK9DsZyhBqc3zR1e83o8aQcsMa
"""
...
map_data.get_nodes_dict()

map_data.edges

map_data.lines

map_data.lines_distance
...
graph = graph(map_data.vertices,map_data.edges,map_data.lines_distance_coded)

graph.edges[0]

graph.create_ady_matrix()

map_data.nodes_dict

len(graph.ady_matrix[0])

graph.ady_matrix

map_data.lines_distance_coded
